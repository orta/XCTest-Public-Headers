...
- (id)snapshotForApplicationWithPID:(int)arg1 attributeList:(id)arg2 error:(id *)arg3;
- (id)_snapshotForElement:(struct __AXUIElement *)arg1 withRootElement:(struct __AXUIElement *)arg2 attributeList:(id)arg3 error:(id *)arg4;
